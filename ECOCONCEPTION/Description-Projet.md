...
A ce stade du projet, réussi à collecter les données des différents capteurs, les formater au format JSON et à connecter le module GSM USR-DR154 au broker MQTT HiveMQ Cloud. Nous utilisons le protocole de communication MQTT car il est moins gourmand en ressources que le protocole HTTP.
La partie technique sera plus abordée dans le fichier Unite-Fonctionnelle.md.
