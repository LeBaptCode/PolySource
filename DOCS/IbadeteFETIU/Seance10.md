...
La prochaine séance sera consacrée au début de la conception matérielle du système, avec la réalisation du PCB de la boîte sur le logiciel Eagle. Cette étape permettra de passer progressivement d’un prototype utilisant des cartes et câblages séparés vers une solution plus intégrée et propre, en concevant un circuit imprimé adapté aux besoins du projet.
